...
test_equal($tree[1]['kind'], 'FOLDER', 'tested folder had incorrect kind');
test_equal($tree[1]['name'], 'ninjas', 'tested folder had incorrect name');
test_equal($tree[1]['path'], '/cake/ninjas', 'tested folder had incorrect path');
