...
$teamRepo = GitRepository::createRepository($test_repos_path.'/team');
...
function validateZip($zipPath, $hash, $robotData)
{
	...
	assertZippedFileContent($zip, 'user/.user-rev', $hash, 'user code revision');
...
validateZip($zipPath, $hash1, $robotData1);

$zipPath2 = $test_zip_path.'/robot2.zip';
$helper->buildZipFile($zipPath2, $hash2);
validateZip($zipPath2, $hash2, $robotData2);
